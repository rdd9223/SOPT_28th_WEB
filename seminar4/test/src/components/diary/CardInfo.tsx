...
function CardInfo({ data, isReadOnly, handleChange }: ICardInfoProps) {
  ...
  return (
    <CardInfoWrap>
      <div className="info__photo">
        <img src={image || EmptyImage} width={image && "210px"} height={image && "210px"} alt="" />
      </div>
      <div className="info__data-wrap">
        ...
        <div className="info__tags">
          ...
          {tags.length > 0 ? (
            ...
            <input type="text" readOnly={true} value="" placeholder="태그를 선택해 주세요" />
          )}
        </div>
        <span>한 줄 요약</span>
        <input
          ...
          onChange={handleChange}
          readOnly={isReadOnly}
          style={{ background: isReadOnly ? "white" : "#EFEFEF" }}
        />
      </div>
    </CardInfoWrap>
  );
